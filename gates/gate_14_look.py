...
The Godot garden is built from primitives in script and ships no models, textures or audio, so everything
under viewer/godot/ that is not Godot's own cache counts, scripts and shaders included, and a texture that
creeps in later is caught here.
