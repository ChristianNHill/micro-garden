"""Personality knobs and label presets.
...
# music_affinity: the noisy and lively like music, the timid, quiet and sleepy keep away
LABELS = {
    ...
    "No personality": dict(),
    # ours
    # seeks company and gets hungry fast, so food defense comes up often
...
def label_of(k: dict[str, np.ndarray], i: int) -> str:
    """The label duck i's knobs sit nearest to. Saves keep knobs, not labels, so this names a loaded duck."""
